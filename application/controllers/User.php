...
class User extends MY_Controller
{
    ...
    function register()
    {
        ...
        if ($this->input->post()) {
            $this->form_validation->set_rules('name', 'First & Last name', 'required|min_length[8]');
            $this->form_validation->set_rules('email', 'Email', 'required|valid_email|callback_check_email');
            $this->form_validation->set_rules('password', 'Password', 'required|min_length[6]');
            $this->form_validation->set_rules('repassword', 'Re-enter your password', 'matches[password]');
            ...
            if ($this->form_validation->run()) {
                ...
                if ($this->user_model->create($data)) {
                    ...
                    $this->session->set_flashdata('message', 'Created Success');
                } else {
                    $this->session->set_flashdata('message', 'Not Created Success');
                }
