            ...
            <div class="widget">
                ...
                <div class="tab_container">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <span class="oneTwo"><input class="form-control" type="text" _autocheck="true" id="param_info" name="info"></span>
                            <span class="autocheck" name="name_autocheck"></span>
                            <div class="clear error" name="name_error"></div>
                        </div>
                        <div class="clear"></div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <span class="oneTwo"><input class="form-control" type="text" _autocheck="true" id="param_sort_order" name="sort_order"></span>
                            <span class="autocheck" name="name_autocheck"></span>
                            <div class="clear error" name="name_error"></div>
                        </div>
                        <div class="clear"></div>
